...
import { StyleSheet, View, Text, Platform, Header } from 'react-native'
import { Bubble, GiftedChat, SystemMessage, IMessage } from '../../src_message' 
...
export default class ConvoPage extends Component {
  state = {
    inverted: false,
    step: 0,
    messages: [],
